...
function renderProductChicken() {
    productChicken.forEach( (productChicken) => {
        productsC.innerHTML += `
            <div class="content">
				<div class="pics">
					<img alt="${productChicken.alt}" class="contentImage" src="${productChicken.imgSrc}">
					<div class="overlay">
				...
				<div class="contentText">
					...
					<small class="productDesc">${productChicken.description}</small>
				</div>
...
function renderProductFuncit() {
    productFuncit.forEach( (productFuncit) => {
        productsF.innerHTML += `
            <div class="content">
				<div class="pics">
					<img alt="${productFuncit.name}" class="contentImage" src="${productFuncit.imgSrc}">
					<div class="overlay">
				...
				<div class="contentText">
					...
					<small class="productDesc">${productFuncit.description}</small>
				</div>
...
function renderProductBangus() {
    productBangus.forEach( (productBangus) => {
        productsB.innerHTML += `
            <div class="content">
				<div class="pics">
					<img alt="${productBangus.name}" class="contentImage" src="${productBangus.imgSrc}">
					<div class="overlay">
				...
				<div class="contentText">
					...
					<small class="productDesc">${productBangus.description}</small>
				</div>
...
function renderProductOthers() {
    productOthers.forEach( (productOthers) => {
        productsO.innerHTML += `
            <div class="content">
				<div class="pics">
					<img alt="${productOthers.name}" class="contentImage" src="${productOthers.imgSrc}">
					<div class="overlay">
				...
				<div class="contentText">
					...
					<small class="productDesc">${productOthers.description}</small>
				</div>
...
function renderCartItems() {
	...
	cart.forEach((item) => {
		...
		<div class="cartContent">
				<div class="cartPics">
					<img alt="${item.alt}" class="contentImage" src="${item.imgSrc}">
